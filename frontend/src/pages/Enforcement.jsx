  ...
  return (
    <div className="flex flex-col xl:flex-row gap-6 p-6 animate-fade-in min-h-screen">
      ...
      <div className="flex-1 space-y-6 min-w-0">
        ...
        {/* Content Render based on active view */}
        {activeView === 'dashboard' && <GarudaCommandDashboard />}
        {activeView === 'field_hub' && <FieldOperationsHub perms={perms} />}
  ...
  return (
    <div className="card p-6 animate-fade-in" style={{ background: 'var(--color-garuda-800)', border: '1px solid var(--color-garuda-700)' }}>
      ...
      {loading ? (
        ...
        <div className="p-12 border border-dashed rounded-xl flex flex-col items-center justify-center text-center" style={{ borderColor: 'var(--color-garuda-700)', background: 'var(--color-garuda-900)' }}>
          ...
          <h3 className="text-lg font-medium text-gray-300">No Activity Found</h3>
          <p className="text-sm text-gray-500 mt-2 max-w-md">Your historical check-ins, paths, and verified coordinates will be plotted here in a detailed timeline view.</p>
        </div>
      ) : (
