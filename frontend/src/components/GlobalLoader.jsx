...
export default function GlobalLoader() {
  ...
  return (
    <div className="absolute inset-0 z-50 flex flex-col items-center justify-center backdrop-blur-sm bg-slate-900/10 dark:bg-slate-950/20 transition-all duration-300 pointer-events-auto">
